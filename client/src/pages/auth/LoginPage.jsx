                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative rounded-md shadow-sm">
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full rounded-lg border border-gray-300 py-3 pl-10 pr-10 text-gray-700 placeholder-gray-500 focus:border-blue-600 focus:outline-none focus:ring-1 focus:ring-blue-600"
                                    placeholder='••••••••'
                                />
                            </div>
                        </div>
